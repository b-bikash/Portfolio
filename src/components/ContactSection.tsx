        ...
        <div className="grid lg:grid-cols-2 gap-10 max-w-5xl mx-auto">
              ...
              {[
                {
                  icon: Mail,
                  label: "Email",
                  value: "contact@bikashbaruah.in",
                  href: "mailto:contact@bikashbaruah.in",
                },
                {
                  icon: Phone,
                  label: "Phone",
                  value: "+91 8761075117",
                  href: "tel:+918761075117",
                },
                {
                  icon: Linkedin,
                  label: "LinkedIn",
                  value: "bikash-baruah-20",
                  href: "http://www.linkedin.com/in/bikash-baruah-20",
                },
                {
                  icon: Github,
                  label: "GitHub",
                  value: "b-bikash",
                  href: "https://github.com/b-bikash",
                },
                {
                  icon: Instagram,
                  label: "Instagram",
                  value: "__b1kash__",
                  href: "https://www.instagram.com/__b1kash__/",
                },
              ].map((item) => (
                <a
                  key={item.label}
          ...
          <ScrollReveal delay={0.2}>
            <form
              ...
              className="card-gradient rounded-xl p-6 shadow-card border border-border space-y-4"
            >
              <div>
