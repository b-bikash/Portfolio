              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                    A full-stack online examination platform with secure
                    authentication, role-based access, and advanced anti-cheat
                    mechanisms for exam integrity.
                  </p>
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                Designed and developed a full-stack online examination platform
                using ASP.NET Core and SQL Server, supporting secure
                authentication, role-based access (Admin, Teacher, Student), and
              ...
              <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                Built with clean architecture principles, service layers,
                validation mechanisms, soft delete patterns, and optimized
